...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfname, tlname, tfaddress, tfphone, tfaadhar,tempid, tfemail, tfsalary, tfdesignation;
    JDateChooser dcdob;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                ...
                String query2 = "insert into emplogin values('"+empId+"','"+empId+"')";
